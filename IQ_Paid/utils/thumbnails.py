...
async def get_thumb(videoid):
    ...
    try:
        ...
        font = safe_font("IQ_Paid/assets/font.ttf", 30)
        font2 = safe_font("IQ_Paid/assets/font.ttf", 30)
        arial = safe_font("IQ_Paid/assets/font2.ttf", 30)
        # Draw text
        ...
        rec_font = safe_font("IQ_Paid/assets/font.ttf", 40)
        rec_text = "ISTU"
