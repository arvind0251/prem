...
from IQ_Paid.utils.database import add_sudo, remove_sudo
from IQ_Paid.utils.decorators.language import language
from IQ_Paid.utils.extraction import extract_user
from IQ_Paid.utils.inline import close_markup
...
async def sudoers_list(client, message: Message):
    keyboard = [
        [primary_button(text="๏ ᴠɪᴇᴡ sᴜᴅᴏʟɪsᴛ ๏", callback_data="check_sudo_list")]
    ]
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        ...
        keyboard.append([primary_button(text="๏ ʙᴀᴄᴋ ๏", callback_data="back_to_main_menu")])
...
async def back_to_main_menu(client, callback_query: CallbackQuery):
    keyboard = [[primary_button(text="๏ ᴠɪᴇᴡ sᴜᴅᴏʟɪsᴛ ๏", callback_data="check_sudo_list")]]
