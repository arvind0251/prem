...
from IQ_Paid.utils.database import get_lang, set_lang
from IQ_Paid.utils.decorators import ActualAdminCB, language, languageCB
...
def lanuages_keyboard(_):
    ...
    keyboard.row(
        ...
        danger_button(text=_["CLOSE_BUTTON"], callback_data=f"close"),
    )
    return keyboard
