...
from IQ_Paid.utils.decorators.admins import ActualAdminCB
from IQ_Paid.utils.decorators.language import language, languageCB
from IQ_Paid.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from IQ_Paid.utils.inline.start import private_panel
...
async def gib_repo_callback(_, callback_query):
    await callback_query.edit_message_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    primary_button(text="• ʙᴀᴄᴋ •", callback_data="back_cb"),
                    danger_button(text="• ᴄʟᴏsє •", callback_data="close")
                ]
            ]
        ),
    )
